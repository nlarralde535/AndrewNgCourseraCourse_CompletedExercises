...
%% Load Datafprintf('Program paused. Press enter to continue.\n');
pause;
...
alpha1 = 0.01;         % Choose some alpha value      
theta = zeros(3, 1);  % MUST re-Init Theta before running Grad. Descent
[theta, J_history] = gradientDescentMulti(X, y, theta, alpha1, num_iters);

alpha2 = 0.03;        % Choose some alpha value
theta = zeros(3, 1);  % MUST re-Init Theta before running Grad. Descent
[theta, J_history2] = gradientDescentMulti(X, y, theta, alpha2, num_iters);

alpha3 = 0.1;        % Choose some alpha value
theta = zeros(3, 1);  % MUST re-Init Theta before running Grad. Descent
[theta, J_history3] = gradientDescentMulti(X, y, theta, alpha3, num_iters);

alpha4 = 0.3;        % Choose some alpha value
theta = zeros(3, 1);  % MUST re-Init Theta before running Grad. Descent
[theta, J_history4] = gradientDescentMulti(X, y, theta, alpha4, num_iters);
